            ...
            var submodelElements = new List<ISubmodelElement>
                           {
                               ...
                               new MultiLanguageProperty(
                                                         ...
                                                         value: [new LangStringTextType(TitleLanguage, Title)]
                                                        ),
                               new MultiLanguageProperty(
                                                         ...
                                                         value: [new LangStringTextType(DescriptionLanguage, Description)]
                                                        ),
                               new Property(
        ...
        private SubmodelElementList ToDigitalFilesList()
        {
            var fileElements = DigitalFiles
                               .Select(ISubmodelElement (f) => f.ToFileElement(
                                                                               HandoverDocumentationSemantics.IdShortDigitalFiles + "_File",
                                                                               null // list handles semanticIdListElement if your SDK supports it
                                                                              ))
                               .ToList();
